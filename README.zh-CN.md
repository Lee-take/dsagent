...
<p align="center">
  <a href="https://github.com/Lee-take/dsagent/releases/tag/v1.0.0">v1.0.0 正式稳定版</a> ·
  <a href="https://github.com/Lee-take/dsagent/releases/download/v1.0.0/DS.Agent_1.0.0_x64-setup.exe">下载 Windows 安装包</a> ·
...
v1.0.0 仍未开放生产 Microsoft/Google 账号注册和真实外部写入权限。当前正式版不会登录
...
- 安装包：`DS.Agent_1.0.0_x64-setup.exe`
- 大小：`12,714,575 bytes`
- SHA-256：`3B944589C8443A677AF55F8748C06A4D6EBA4ACE86E63E302D5782D5A5E548E4`
- 验证：192 个文件的密钥扫描、前端 production build、全部 Node/UI 检查以及 852 项 Rust
