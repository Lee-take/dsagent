...
## DeepSeek-First Check

- [ ] This change preserves the DeepSeek-first positioning.
- [ ] This change does not imply official DeepSeek affiliation.
- [ ] This change does not add new product capabilities during the alpha freeze.
