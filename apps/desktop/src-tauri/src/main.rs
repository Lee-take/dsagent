...
use commands::{
    archive_memory_candidate_conflicts, archive_memory_from_maintenance_review,
    bind_durable_computer_use_action, browse_url, cancel_durable_computer_use_step,
    ...
    list_task_grouped_authorizations, list_task_records, merge_memory_candidate_with_conflicts,
    prepare_skill_execution_record, preview_local_skill_package_manifest,
    preview_local_skill_zip_package, preview_memory_candidate_merge,
    preview_memory_candidate_replace, preview_remote_skill_zip_package,
    preview_work_package_import, propose_memory_candidate,
    ...
    resolve_capability_access_request, resolve_memory_candidate,
    resolve_task_grouped_authorization, resume_agent_chat_action,
    revoke_task_grouped_authorization, run_agent_chat, run_durable_computer_use_step,
    ...
    save_deepseek_api_key, save_deepseek_pricing_settings, save_local_directory_settings,
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            bind_durable_computer_use_action,
            run_durable_computer_use_step,
            take_over_durable_computer_use_step,
            cancel_durable_computer_use_step,
            list_durable_computer_use_sessions,
            list_durable_computer_use_steps,
            read_email_boundary,
