...
function checkRequiredDocs() {
  ...
  for (const [phrase, label] of [
    ...
    ["v1.5.0 stable", "English README formal stable status"],
    ...
    ["Production Microsoft/Google account registration and live external-write authority remain disabled in v1.5.0", "English README connector authority boundary"],
    ["Exact installed evidence is limited to generated File Explorer and Excel targets plus installed Edge with a fresh profile and an ephemeral loopback test portal", "English README exact Computer Use evidence boundary"],
  ...
  for (const [phrase, label] of [
    ...
    ["v1.5.0 正式稳定版", "Chinese README formal stable status"],
    ...
    ["v1.5.0 仍未开放生产 Microsoft/Google 账号注册和真实外部写入权限", "Chinese README connector authority boundary"],
    ["准确安装态证据只覆盖生成的 File Explorer、Excel 目标，以及使用全新 profile 和临时回环测试站点的已安装 Edge", "Chinese README exact Computer Use evidence boundary"],
...
function checkPublicReleaseCopyPositioning() {
  ...
  checkTextIncludes(
    ...
    'APP_UPDATE_USER_AGENT: &str = "DS-Agent-Updater/1.5.0"',
    "app updater User-Agent v1.5.0",
  );
  checkTextIncludes(
    "apps/desktop/src-tauri/src/kernel/app_update.rs",
    readText("apps/desktop/src-tauri/src/kernel/app_update.rs"),
    'APP_UPDATE_CURRENT_RELEASE_TAG: &str = "v1.5.0"',
    "app updater current release tag v1.5.0",
  );
  checkTextDoesNotInclude(
    "apps/desktop/src-tauri/src/kernel/app_update.rs",
    readText("apps/desktop/src-tauri/src/kernel/app_update.rs"),
  ...
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.5.0.md",
    readText("docs/RELEASE_NOTES_v1.5.0.md"),
    "Package, desktop, Tauri, Cargo, updater, and installer metadata are `1.5.0` / `v1.5.0`.",
    "v1.5.0 stable release notes version identity",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.5.0.md",
    readText("docs/RELEASE_NOTES_v1.5.0.md"),
    "Both `ds-agent.exe` and `DS.Agent_1.5.0_x64-setup.exe` are intentionally Authenticode `NotSigned`",
    "v1.5.0 dual-artifact unsigned disclosure",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.5.0.md",
    readText("docs/RELEASE_NOTES_v1.5.0.md"),
    "The Edge DOM helper is compiled only for Windows tests",
    "v1.5.0 test-only Edge DOM boundary",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.5.0.md",
    readText("docs/RELEASE_NOTES_v1.5.0.md"),
    "The named File Explorer, Excel, and Edge/local-portal cases are exact installed-test evidence; they are not a promise that every application, workbook, website, or desktop layout is supported",
    "v1.5.0 installed-test reachability boundary",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.5.0.md",
    readText("docs/RELEASE_NOTES_v1.5.0.md"),
    "DeepSeek remains advisory and cannot approve an action or mint authority, evidence, verification, or completion",
    "v1.5.0 model authority boundary",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.5.0.md",
    readText("docs/RELEASE_NOTES_v1.5.0.md"),
    "This release does not add Step 6 persistent automation/recovery work",
    "v1.5.0 Step 6 exclusion",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.5.0.md",
    readText("docs/RELEASE_NOTES_v1.5.0.md"),
    "The final Step 5 matrix records 30 installed application runs: 10 File Explorer, 10 Excel, and 10 Edge/local-portal",
    "v1.5.0 installed reliability denominator",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.4.0.md",
  ...
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.0.2.md",
    readText("docs/RELEASE_NOTES_v1.0.2.md"),
    "Package, desktop, Tauri and Cargo metadata are `1.0.2`, and the updater identity is `v1.0.2`.",
    "v1.0.2 stable release notes updater identity",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.0.2.md",
    readText("docs/RELEASE_NOTES_v1.0.2.md"),
    "Protocol JSON is never shown in place of the user-facing reply",
    "v1.0.2 user-facing reply isolation fix",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.0.2.md",
    readText("docs/RELEASE_NOTES_v1.0.2.md"),
    "Calling DeepSeek with the user's configured API Key is not a per-run approval action",
    "v1.0.2 DeepSeek step approval semantics",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.0.2.md",
    readText("docs/RELEASE_NOTES_v1.0.2.md"),
    ...
    "v1.0.2 release validation boundary",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v1.0.1.md",
  ...
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v0.4.1.md",
    readText("docs/RELEASE_NOTES_v0.4.1.md"),
    "Bumps the package, desktop, Tauri, Cargo, and updater metadata to `0.4.1` / `v0.4.1` so installed Windows clients can detect this release as newer than `v0.4.0`.",
    "v0.4.1 release notes updater version bump",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v0.4.1.md",
    readText("docs/RELEASE_NOTES_v0.4.1.md"),
    "This patch removes the tracked `.codegraph` directory marker from the public source tree.",
  ...
  checkTextIncludes(
    ...
    'invoke<AppUpdateStatus>("check_app_update")',
    "app update UI checks through deterministic local command",
  );
  checkTextIncludes(
    "apps/desktop/src/App.tsx",
    readText("apps/desktop/src/App.tsx"),
    'invoke<AppUpdateDownloadResult>("download_app_update")',
    "app update UI downloads silently through deterministic local command",
  );
  checkTextIncludes(
    "apps/desktop/src/App.tsx",
    readText("apps/desktop/src/App.tsx"),
  ...
  checkTextIncludes(
    ...
    "app update UI only shows install after download validation",
  );
  checkTextIncludesCollapsed(
    "docs/RELEASE_NOTES_v0.1.0.md",
    releaseNotes,
...
function checkGovernanceDocs() {
  ...
  checkTextIncludesCollapsed(
    "SECURITY.md",
    securityPolicy,
    "DS Agent v1.5.0 is the current published stable release",
  ...
  checkTextIncludesCollapsed(
    "SECURITY.md",
    securityPolicy,
    "Current stable v1.5.0 stores one user-supplied DeepSeek API key in a dedicated Windows DPAPI vault",
...
function checkCodeSigningAndPrivacyPolicies() {
  ...
  for (const [phrase, label] of [
    ...
    ["DS Agent `v1.5.0` is intentionally published unsigned", "code-signing current unsigned status"],
  ...
  for (const [phrase, label] of [
    ...
    ["The current stable `v1.5.0` accepts one user-supplied DeepSeek API key", "privacy current credential behavior"],
    ...
    ["Production Microsoft and Google account registration and live mail/calendar writes are disabled in `v1.5.0`", "disabled connector privacy boundary"],
  ...
  for (const [filePath, content] of [["README.md", readme], ["README.zh-CN.md", readmeZh]]) {
    ...
    checkTextIncludes(filePath, content, "docs/RELEASE_NOTES_v1.5.0.md", `${filePath} v1.5.0 release-notes link`);
...
function checkReproducibleWindowsReleaseBuild() {
  ...
  checkTextIncludesCollapsed(
    ...
    "v1.5.0 release notes disclose reproducibility gate",
  );
}
